...
- Partners include: USC, UCLA, Boston University, Purdue, Northeastern, GWU, SMU, Wake Forest, Tulane, DePaul, Emory, University of Florida, Johns Hopkins, Columbia, MTSU, Pace, Arizona, Delaware

**CASE STUDIES - USE STRATEGICALLY BASED ON CONTACT'S DIVISION:**

📊 BUSINESS (use for: Business School, MBA programs)
- MTSU Online MBA: 1,054 students enrolled, grew from ~0 to 1,000+ over 5 years
- USC Marshall Online MBA: 662 students, partnership since 2015, re-partnered 2023 after decline without AllCampus
- Pace University Business: 196 students enrolled

📊 ENGINEERING (use for: Engineering, CS, Technology)
- GWU School of Engineering: 1,673 students across 3 MS programs (Cybersecurity 892, Engineering Management 390, Systems Engineering 391)
- UCLA Engineering: 77 students in first year across 2 new Master's programs
- University of Arizona ECE: 523+ students enrolled in MS Electrical & Computer Engineering

📊 SOCIAL WORK (use for: Social Work, Human Services)
- Adelphi University MSW: 508 students, grew from 35 to 118 annually over 6 years
- Columbia School of Social Work MSW: 200 students in first year, grew to 214 in year 2

📊 LAW/LEGAL (use for: Law Schools, Legal Studies)
- Vanderbilt MLS: 67 students enrolled in new program launch
- Northeastern Master of Legal Studies: 250 students, grew from 53 to 83 at peak

📊 EDUCATION (use for: Education, Teaching, Music Ed, Art Ed)
- Teachers College Columbia: MA in Music and Music Education, 190 students enrolled
- University of Florida School of Education: 608 students (Art Education 196, Music Education 412)
- Pace University Education: 118 students enrolled

📊 HEALTH/KINESIOLOGY (use for: Health Sciences, Public Health, Kinesiology, Sport Management)
- UCLA Master of Healthcare Administration: 230 students enrolled
- University of Florida Health & Human Performance: 1,573 students (Sport Management 825, Applied Physiology & Kinesiology 598, Health Education 150)

📊 PUBLIC POLICY/SOCIAL SCIENCES (use for: Public Policy, Public Admin, Criminal Justice, Political Science)
- Northeastern College of Social Science & Humanities: 530 students (Criminal Justice 174, Public Policy 186, Public Administration 170)
- Johns Hopkins: 184 students across niche programs (International Affairs 92, Sustainability 92)

📊 COMPUTER SCIENCE/IT (use for: CS, IT, Information Systems)
- Pace University Computer Science & Information Systems: 272 students enrolled
- GWU Cybersecurity: 892 students enrolled

📊 SCIENCE/ANALYTICS (use for: Statistics, Data Science, Analytics, Sciences)
- University of Delaware MS in Applied Statistics: 133 students enrolled

📊 SPATIAL SCIENCE/GIS (use for: Geography, GIS, Geospatial)
- USC Dornsife Spatial Science Institute: 365 students (Geographic Info Science 202, Human Security & Geospatial Intel 50, plus certificates)

📊 ENTERPRISE/FULL PARTNERSHIP (use for: Provost, President, VP, institution-wide leaders)
- Pace University: 890 total students across entire portfolio (Arts & Sciences 161, Business 196, Education 118, Computer Science 272, Undergraduate 143) - demonstrates full-institution partnership capability

📊 NEW PROGRAM LAUNCHES (use when discussing launching new online programs)
- 419 students enrolled across 4 new program launches in first academic year
- Columbia MSW: 200 students in year 1
- UCLA Engineering: 77 students in year 1
- USC MBA Spring 2024: 75 students (highest spring start ever)
- Vanderbilt MLS: 67 students in year 1

**CASE STUDY MATCHING RULES:**
1. Match case study to contact's DIVISION/COLLEGE - a Dean of Engineering should hear about GWU Engineering, not MBA
2. For institution-wide leaders (Provost, President, VP), use Pace enterprise partnership or aggregate stats
3. If no direct match exists, either use adjacent field OR skip case study entirely - don't force irrelevant examples
4. Never use MBA case studies for non-business contacts unless they're institution-wide leaders
5. When mentioning competitor schools by name, that's OK - it shows credibility
...
1. **🚨 NEGATIVE DATA FRAMING (MOST IMPORTANT) 🚨**
   NEVER tell the email writer to lead with or explicitly state negative numbers about the prospect's institution.
   
   BAD strategy: "Lead with: The 75% decline in online graduate completions"
   BAD must_mention: "Online completions declining from 71 to 18"
   BAD subject line: "Your online grad decline"
   
   GOOD strategy: "Lead with: A soft acknowledgment that their online portfolio shows mixed results, then pivot to a partner who reversed similar trends"
   GOOD must_mention: "Reference that some programs grew while others dipped (without specific negative numbers)"
   GOOD subject line: "online grad growth at peer institutions"
   
   The email writer will put specific negative numbers in the PARTNER'S story, not the prospect's.
   Your job is to give them the data but tell them to frame it softly.
   
   When completions data shows decline:
   - Acknowledge it exists, but DON'T say "Lead with the 75% decline"
   - Instead say "Lead with: A partner success story about reversing similar enrollment challenges"
   - Put specific decline numbers in "good_to_mention" with note: "(use in partner story context, not about prospect directly)"

2. **NO UNFOUNDED ASSUMPTIONS** - Only state things you have evidence for. If data is missing, say so. Never fabricate pain points.

3. **CONTACT SCOPE** - Determine their organizational scope:
...
7. **EMAIL STYLE SELECTION** - Choose email styles based on persona type:

   STYLE DEFINITIONS:
   - **Demand-Jen**: News hook → Partner case study → "Care to see the case study?"
   - **Transparent**: Direct meeting ask above fold, clear why + what we do + calendar
   - **Insight-Lead**: Open with market trend/insight they may not know, tie to their situation
   - **Peer-Comparison**: Reference what similar institutions are doing (creates relevance)
   - **Value-First**: Offer something tangible upfront before asking for time
   - **Nudge**: One-liner follow-up ("Just giving this a nudge")
   - **Proof-Point**: Short credibility builder with specific result

   PERSONA → STYLE MATCHING:
   - Data-Driven Operator → Transparent or Insight-Lead (they want facts, directness)
   - Relationship Builder → Peer-Comparison or Value-First (they want connection, reciprocity)
   - Innovator/Visionary → Insight-Lead or Demand-Jen (they want new ideas, trends)
   - Risk-Averse Administrator → Value-First or Peer-Comparison (they want proof, safety)
   - Growth-Focused Strategist → Demand-Jen or Transparent (they want results, action)

   IMPORTANT: Email 4 style MUST be different from Email 1 style.
...

{
  ...
  "email_style_strategy": {
    "email_1_style": "REQUIRED - Choose ONE based on persona: Demand-Jen | Transparent | Insight-Lead | Peer-Comparison | Value-First",
    "email_1_style_reasoning": "Why this style fits this persona/situation",
    "email_2_style": "REQUIRED - Choose ONE: Nudge | Proof-Point | Insight-Lead",
    "email_4_style": "REQUIRED - Choose ONE different from email_1: Demand-Jen | Transparent | Insight-Lead | Peer-Comparison | Value-First"
  },

  "email_by_email_strategy": {
    "email_1": {
      "purpose": "The Hook - grab attention with something specific",
      "style": "Must match email_1_style from above",
      "lead_with": "A POSITIVE or NEUTRAL hook (news, initiative, growth area). If data is negative, lead with partner success story instead. NEVER lead with their decline numbers.",
      "angle": "The specific angle/framing - if discussing challenges, frame softly ('mixed results', 'room to grow') not harshly ('75% decline')",
      "tone_note": "Any tone adjustments for this email",
      "word_count": "50-75"
    },
    "email_2": {
      "purpose": "The Proof or Nudge - short follow-up",
      "style": "Must match email_2_style from above",
    ...
    "email_4": {
      ...
      "style": "Must match email_4_style from above - should be DIFFERENT from email_1",
  ...
  "specific_references": {
    "must_mention": ["Specific POSITIVE details that MUST be referenced (news, growth areas, initiatives). NEVER include negative numbers about the prospect here."],
    "good_to_mention": ["Optional details including negative trends, BUT note: 'use in partner story context, not about prospect directly'"],
    "do_not_mention": ["Things to avoid - include any temptation to lead with prospect's negative numbers"]
  },
  ...
  "subject_line_suggestions": {
    "email_1": "5-8 word subject line - NEVER reference their decline or problems. Focus on opportunity, peer success, or neutral topic.",
    "email_4": "5-8 word subject line for fresh thread - positive/neutral framing only"
  },
...
function formatStrategicSummary(analysis, name, institution, rawData) {
  ...
  // Email Style Strategy
  if (analysis.email_style_strategy) {
    const s = analysis.email_style_strategy;
    lines.push('┌──────────────────────────────────────────────────────────────────────────────┐');
    lines.push('│ 🎨 EMAIL STYLE STRATEGY                                                      │');
    lines.push('└──────────────────────────────────────────────────────────────────────────────┘');
    if (s.email_1_style) lines.push(`Email 1 Style: ${s.email_1_style}`);
    if (s.email_1_style_reasoning) lines.push(`   Reasoning: ${s.email_1_style_reasoning}`);
    if (s.email_2_style) lines.push(`Email 2 Style: ${s.email_2_style}`);
    if (s.email_4_style) lines.push(`Email 4 Style: ${s.email_4_style}`);
    lines.push('');
  }
  ...
  if (analysis.email_by_email_strategy) {
    ...
    if (ebs.email_1) {
      ...
      if (ebs.email_1.style) lines.push(`  Style: ${ebs.email_1.style}`);
    ...
    if (ebs.email_2) {
      ...
      if (ebs.email_2.style) lines.push(`  Style: ${ebs.email_2.style}`);
    ...
    if (ebs.email_4) {
      ...
      if (ebs.email_4.style) lines.push(`  Style: ${ebs.email_4.style}`);
